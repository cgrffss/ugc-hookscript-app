    ...
    <div className="w-full min-h-[95vh] flex flex-col px-5 pt-12 pb-32 bg-background relative overflow-y-auto">
      ...
      <div className="grid grid-cols-2 gap-3 z-10">
         {generations.map((gen, i) => (
            <div key={i} className="bg-[#151221] p-3 rounded-[20px] border border-[#261f3d] flex flex-col relative overflow-hidden group">
               <div className="w-full aspect-[4/5] bg-[#110e1b] rounded-[14px] mb-3 relative overflow-hidden border border-white/5">
                  {gen.thumbnail_url || gen.input_image ? (
                     <img src={gen.thumbnail_url || gen.input_image} alt="Video Thumbnail" className="w-full h-full object-cover opacity-80" />
                  ) : (
               ...
               <h3 className="text-white font-bold text-[14px] truncate mb-1">{gen.product_name}</h3>
